            ...
            {filteredConversations.map((conv) => (
              ...
              >
                ...
                <div className="relative flex-shrink-0">
                  ...
                  />
                  {conv.unreadCount > 0 && (
                    <div className="absolute -top-1 -right-1 w-6 h-6 bg-orange-500 text-text-primary text-xs font-bold rounded-full flex items-center justify-center">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    <h3 className="font-bold text-text-primary truncate">{conv.user.name}</h3>
                    {conv.lastMessage && (
                  ...
                  <p className={`text-sm truncate ${conv.unreadCount > 0 ? 'text-text-primary font-semibold' : 'text-text-muted'}`}>
                ...
                <button
                  ...
                  className="p-2 hover:bg-white/10 rounded-full text-text-muted hover:text-text-primary transition-all opacity-0 group-hover:opacity-100"
                >
